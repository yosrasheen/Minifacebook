<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAlbum2.aspx.cs" Inherits="AddAlbum2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> 
<html xml:lang="en" lang="en" xmlns="http://www.w3.org/1999/xhtml" dir=ltr>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=windows-1256" />
<title> Family Gathering ----- Add Album</title>
	...
	<div class="borderwrap">
		<div class="maintitle">
            ...
            <table id="table1" border="0" width="100%">
                <tr>
                    <td colspan="2"><A href="default.aspx">Home</A> |<A href="aboutUs.htm">About Us</A>&nbsp; | contact Us&nbsp; |&nbsp; <A href="news.aspx">News</A> | <A href="member.aspx">Member</A>
                        </td>
                </tr>
                <tr>
					...
					<fieldset align='middle' >
						...
						<table class='ipbtable' cellspacing="0" width="100%">
							<tr>
								...
								The Album has been created successfully</b></td>
							</tr>
							</table>
                        <br />
                        <asp:Button ID="Button1" runat="server" Text="Add pictures now  >>>>" class="button" OnClick="Button1_Click" /><br />
                    </fieldset>
                    <br />
				</td>
...
<p class="pcen"><span style="color: #0000ff">
    <a href="default.aspx">Home</a>
    |<a href="aboutUs.htm">About
        Us</a>&nbsp; | <a href="contactUs.aspx">contact Us</a>&nbsp; |&nbsp; <a href="news.aspx">News</a> | <a href="member.aspx">Member</a></span></p>
