<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deletePicture.aspx.cs" Inherits="deleteAlbum" %>
					...
					<fieldset align='middle' >
						...
						<table class='ipbtable' cellspacing="0" width="100%">
							<tr>
								...
								The picture has been deleted successfully</b></td>
							</tr>
							</table>
                        <br />
                        <asp:Button ID="Button1" runat="server" CssClass="button" OnClick="Button1_Click"
                            Text="Back to the Pictures >>>" />&nbsp;<br />
                    </fieldset>
				</td>
